...
namespace Azul
{
	...
	void Camera::GetHelper(Vect& up, Vect& tar, Vect& pos,
		Vect& upNorm, Vect& forwardNorm, Vect& pRightNorm)
	{
		this->getPos(pos);
		this->getLookAt(tar);
		this->getUp(upNorm);
	...
	void Camera::SetHelper(Vect& up_pt, Vect& tar_pt, Vect& pos_pt)
	{
		Vect upVect = up_pt - pos_pt;
