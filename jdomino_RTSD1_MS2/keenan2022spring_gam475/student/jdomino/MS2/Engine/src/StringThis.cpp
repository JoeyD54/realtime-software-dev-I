...
StringThis::StringThis(Texture::Name status)
{
	...
	case Texture::Name::ROCKS:
		...
		break;
	case Texture::Name::KT_STONE_1:
		strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Texture::KT_STONE_1));
		break;
	case Texture::Name::KT_STONE_2:
		strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Texture::KT_STONE_2));
		break;
...
StringThis::StringThis(Mesh::Name status)
{
	...
	case Mesh::Name::PYRAMID:
		...
		break;
	case Mesh::Name::TRI_PYRAMID:
		strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::TRI_PYRAMID));
		break;
	case Mesh::Name::DIAMOND:
		strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::DIAMOND));
		break;
